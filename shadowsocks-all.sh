...
libsodium_url="https://github.com/yigeni/Shadowsocks/blob/master/libsodium-1.0.16.tar.gz"

mbedtls_file="mbedtls-2.6.0"
mbedtls_url="https://github.com/yigeni/Shadowsocks/blob/master/mbedtls-2.6.0-gpl.tgz"

shadowsocks_python_file="shadowsocks-master"
shadowsocks_python_url="https://github.com/yigeni/Shadowsocks/blob/master/shadowsocks-master.zip"
shadowsocks_python_init="/etc/init.d/shadowsocks-python"
shadowsocks_python_config="/etc/shadowsocks-python/config.json"
shadowsocks_python_centos="https://github.com/yigeni/Shadowsocks/blob/master/shadowsocks"
shadowsocks_python_debian="https://github.com/yigeni/Shadowsocks/blob/master/shadowsocks-debian"

shadowsocks_r_file="shadowsocksr-3.2.1"
shadowsocks_r_url="https://github.com/yigeni/Shadowsocks/blob/master/shadowsocksr-3.2.1.tar.gz"
shadowsocks_r_init="/etc/init.d/shadowsocks-r"
shadowsocks_r_config="/etc/shadowsocks-r/config.json"
shadowsocks_r_centos="https://github.com/yigeni/Shadowsocks/blob/master/shadowsocksR"
shadowsocks_r_debian="https://github.com/yigeni/Shadowsocks/blob/master/shadowsocksR-debian"

shadowsocks_go_file_64="shadowsocks-server-linux64-1.2.1"
shadowsocks_go_url_64="https://github.com/yigeni/Shadowsocks/blob/master/shadowsocks-server-linux64-1.2.1.gz"
shadowsocks_go_file_32="shadowsocks-server-linux32-1.2.1"
shadowsocks_go_url_32="https://github.com/yigeni/Shadowsocks/blob/master/shadowsocks-server-linux32-1.2.1.gz"
shadowsocks_go_init="/etc/init.d/shadowsocks-go"
shadowsocks_go_config="/etc/shadowsocks-go/config.json"
shadowsocks_go_centos="https://github.com/yigeni/Shadowsocks/blob/master/shadowsocks-go"
shadowsocks_go_debian="https://github.com/yigeni/Shadowsocks/blob/master/shadowsocks-go-debian"

shadowsocks_libev_init="/etc/init.d/shadowsocks-libev"
shadowsocks_libev_config="/etc/shadowsocks-libev/config.json"
shadowsocks_libev_centos="https://github.com/yigeni/Shadowsocks/blob/master/shadowsocks-libev"
shadowsocks_libev_debian="https://github.com/yigeni/Shadowsocks/blob/master/shadowsocks-libev-debian"
...
install_prepare_password() {
    ...
    read -p "(Default password: yigeni.com):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="yigeni.com"
    echo
